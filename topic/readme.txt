...
Go to the [Raptive homepage](https://raptive.com/) to apply for an account.
...
Yes! Anyone using the plugin can log in using their Raptive dashboard account. Email support@raptive.com to create additional users for writers and editors — our SEO-assistant user option gives access to only the Content Optimization features in your dashboard.
...
All Raptive creators and enterprise publishers get full access to the plugin's features. To learn more, see [this article](https://help.raptive.com/hc/en-us/articles/4406596212763-How-to-use-Topic-in-WordPress-and-Google-Docs)
...
Don’t hesitate to reach out at support@raptive.com or the [support portal](https://help.raptive.com/hc/en-us) to submit a ticket. You can expect a quick response from us during our business hours, Monday through Friday, 10 am-5 pm PST.

== Screenshots ==

1. Choose the content brief that matches the post you are editing.
...
General Improvements & Better Tracking
...
Fix bug where content was not detected

= 1.0.26 =
Release Date: AUG 13, 2024
Fixed issues with WP 6.6+ upgrades
